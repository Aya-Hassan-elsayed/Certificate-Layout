...
using System;
public class EditGeometryToGeoJsonResolver : IValueResolver<CertificateViewLayoutEdit, ReturnListDto, string>
{
    public string Resolve(CertificateViewLayoutEdit source, ReturnListDto destination, string destMember, ResolutionContext context)
    {
        try
        {
