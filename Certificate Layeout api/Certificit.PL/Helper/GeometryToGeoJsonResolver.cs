...
using System;
public class GeometryToGeoJsonResolver : IValueResolver<CertificateViewLayout33, ReturnListDto, string>
{
    public string Resolve(CertificateViewLayout33 source, ReturnListDto destination, string destMember, ResolutionContext context)
    {
        try
        {
